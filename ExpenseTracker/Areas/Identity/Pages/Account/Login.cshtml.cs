...
namespace ExpenseTracker.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                AppUser user = await _signInManager.UserManager.FindByNameAsync(Input.UsernameOrEmail)
                              ?? await _signInManager.UserManager.FindByEmailAsync(Input.UsernameOrEmail);
